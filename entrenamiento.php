...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>CABS Capital | Entrenamiento</title>
  ...
  <body>
    ...
    <div class="marketing-site-hero">
      <div class="marketing-site-hero-content">
        ...
        <p class="subheader">Si quieres ingresar a nuestro programa,
          <a href="contacto.php" class="round button">Contáctanos</a>
        .</p>
      </div>
    </div>
    ...
    <footer>
      <div class="wrap row small-up-1 medium-up-3">
        ...
        <div class="column">
          <p align="center"><small>© 2017 – CABS CAPITALS S.A.S.<br />Todos los derechos reservados.<br />No brindamos consejo ni asesoría de inversión.</small></p>
        </div>
        <div class="column"></div>
      </div>
    </footer>
